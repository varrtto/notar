...
export function NoteListItem({ 
  ...
  return (
    <li
      className={`p-4 mx-4 mb-2 border border-gray-200 cursor-pointer transition-all duration-200 relative flex items-start rounded-lg group ${
        isSelected 
    ...
    >
      ...
      <button
        className={'absolute top-3 right-3 bg-transparent border-none cursor-pointer p-1.5 rounded-md'}
        onClick={(e) => {
          e.stopPropagation()
          onDelete(note.id)
        }}
